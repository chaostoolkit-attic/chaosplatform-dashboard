  ...
  export default Vue.extend({
    ...
    methods: {
      ...
      getContext() {
        ...
        const experimentId = this.$route.params.experiment
        return axios.get(
            '/' + orgName + '/' + workspaceName + '/experiment/' + experimentId + '/schedule/with/context', {
            headers: {
              Accept: 'application/json'
            }
          }
      ...
      scheduleExecution() {
        ...
        const experimentId = this.$route.params.experiment
        return axios.post(
            '/' + orgName + '/' + workspaceName + '/experiment/' + experimentId + '/schedule',
            self.schedule,
            {headers: {Accept: 'application/json'}}
        ).then((response) => {
            self.context.schedules.push(response.data)
        }).catch((error) => {
          swal({
    ...
    getScheduleDate(schedule: any): string {
