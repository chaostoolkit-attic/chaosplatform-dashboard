...
export const createRoutes: () => RouteConfig[] = () => [
  ...
  {
    path: '/dashboard/orgs/:org/:workspace/experiment/:experiment',
    component: experimentMainComponent,
    name: 'experiment_default'
  },
  {
    path: '/dashboard/orgs/:org',
  ...
  },
  {
    ...
    name: 'org_settings',
    redirect: '/dashboard/orgs/:org/settings/general',
    components: {
  ...
  {
    path: '/dashboard/orgs/:org/:workspace',
    component: workspaceComponent,
    name: 'workspace_default'
  },
  {
    path: '/dashboard/orgs/:org/:workspace/settings',
    name: 'workspace_settings',
    redirect: '/dashboard/orgs/:org/:workspace/settings/general',
    components: {
  ...
  {
    path: '/dashboard/orgs/:org/:workspace/experiment/:experiment/execution',
    name: 'experiment_runs',
    component: experimentExecutionsComponent
  },
  {
    path: '/dashboard/orgs/:org/:workspace/experiment/:experiment/schedule',
    name: 'experiment_schedule',
    component: experimentScheduleComponent
  },
  {
    path: '/dashboard/orgs/:org/:workspace/experiment/:experiment/execution/:execution',
